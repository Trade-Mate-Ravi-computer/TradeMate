            ...
            <div className='gridstyle grid grid-cols-4'>
                ...
                <div className='border border-gray-100 justify-center col-span-2'>
                    <form className="space-y-6 px-40 py-2" action="/" method="POST">
                        <div>
                            <label for="Item Name" className="block text-sm font-medium leading-6 text-gray-900">Spent On
</label>
                        ...
                        <div>
                            <div className="flex items-center justify-between">
                                <label for="ammount" className="block text-sm font-medium leading-6 text-gray-900">SpentAmmount</label>
                            </div>
                            <div className="mt-2">
