    ...
    const handleOnSubmit = async (e) => {
        ...
        if (sendOtp) {
            ...
            try {
                ...
                const response = await axios.post('https://ec2-34-230-10-177.compute-1.amazonaws.com:8080/auth/updatepassword', newPasswordDetails);
                setLoading(false)
            ...
            try {
                const response = await axios.post(`https://ec2-34-230-10-177.compute-1.amazonaws.com:8080/auth/otp/${newPasswordDetails.email}`, {});
                setLoading(false)
                setOtpStatus(response.data)
