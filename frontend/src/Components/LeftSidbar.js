  ...
  return (
    <div>
      <div className=' border border-blue-100'>
        <NavLink className={`border border-blue-100 justify-center flex font-${props.opendash} hover:border-blue-300 hover:font-semibold hover:bg-blue-100`} to={`/dashboard/${JSON.parse(localStorage.getItem('companyName')).companyName}`}>Dashboard</NavLink>
        ...
        {/* <NavLink className={`border border-blue-100 justify-center flex font-${props.openpurchase} hover:border-blue-300 hover:font-semibold hover:bg-blue-100`} to='/addpurchase'>Add Purchase</NavLink> */}
