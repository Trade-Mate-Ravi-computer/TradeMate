  ...
  return (
    <div>
      <div className=' border border-gray-100'>
        ...
        <NavLink className={`border border-gray-100 justify-center flex font-${props.openemployee} hover:border-gray-300 hover:font-semibold hover:bg-gray-100`} to='/addEmployee'>Add User</NavLink> 
        </div>
    </div>
  )
}
