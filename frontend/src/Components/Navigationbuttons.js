...
function NavigationButtons(props) {
  const navlinkStyle = "m-2 p-2 border border-blue-100 flex justify-center text-blue-700 hover:bg-blue-100 hover:border-blue-300 hover:font-semibold hover:shadow-md hover:scale-105 transition-transform rounded-lg";
