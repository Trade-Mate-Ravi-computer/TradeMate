...
function ProductLists() {
    ...
    const loadProducts = async () => {
        const productDetails = await axios.post("https://ec2-34-230-10-177.compute-1.amazonaws.com:8080/stock/all", { companyName: JSON.parse(localStorage.getItem('companyName')).companyName,
