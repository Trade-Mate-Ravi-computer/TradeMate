    ...
    return (
        <div>
                ...
                <div className="col-span-3">
                    ...
                    <div className="short w-full  h-10 flex justify-end">
                        <div>
                    ...
                    <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        for (let i = saleDetails.length - 1; i >= 0; i--) {
                            items.push(saleDetails[i].remaining>0 ?shortData ? !saleDetails[i].customerName.toLowerCase().includes(shortData.toLowerCase()) ? '' : <tbody key={saleDetails[i].id} className='border border-x-2 my-10 cursor-pointer'>
