    ...
    return (
        <div>
            <div className=' border border-gray-100 w-full'>
                ...
                <NavLink className='border border-gray-100 justify-center flex hover:border-gray-300 hover:font-semibold hover:bg-gray-100' to="/remaining">Remaining List</NavLink>
