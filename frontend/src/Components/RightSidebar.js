    ...
    return (
        <div>
            <div className=' border border-blue-100 w-full'>
                ...
                <NavLink className='border border-blue-100 justify-center flex hover:border-blue-300 hover:font-semibold hover:bg-blue-100' to={`/purchase/${JSON.parse(localStorage.getItem('companyName')).companyName}`}>Purchase List</NavLink>
