...
function Signup() {
    ...
    const emailContent = {
        message: `https://ec2-34-230-10-177.compute-1.amazonaws.com:8080/auth/setverify/${singupDetails.email}`,
    ...
    const handleOnSubmit = (e) => {
        ...
        if (singupDetails.password === singupDetails.confirmPassword) {
            fetch('https://ec2-34-230-10-177.compute-1.amazonaws.com:8080/auth/sign-up', {
                method: "POST",
                headers: {
